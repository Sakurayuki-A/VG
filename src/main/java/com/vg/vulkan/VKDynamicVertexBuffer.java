...
public class VKDynamicVertexBuffer implements AutoCloseable {
    ...
    public VKDynamicVertexBuffer(VkDevice device, VKDevice vkDevice, int maxVertices) {
        this.device = device;
        this.vkDevice = vkDevice;
        this.bufferSize = maxVertices * 6L * 4L;
    ...
    public void updateVertices(float[] vertices, long dstOffset) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            try {
                ...
                copyBuffer(device, vkDevice, stagingBuffer, vertexBuffer, bufferSize, dstOffset);
            } finally {
