...
public class VKPipeline implements AutoCloseable {
    ...
    public VKPipeline(VkDevice device, VKRenderPass renderPass,
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VKUtil.check(result, "Failed to create pipeline layout");
            ...
            VKUtil.check(result, "Failed to create graphics pipeline");
